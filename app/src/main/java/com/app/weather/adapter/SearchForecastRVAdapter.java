...
public class SearchForecastRVAdapter extends RecyclerView.Adapter<SearchForecastRVAdapter.ForecastViewHolder>{
    ...
    List<com.app.weather.model.ForecastWeather.List> weatherList;
    private Context context;
    private String tempUnit;

    public SearchForecastRVAdapter(List<com.app.weather.model.ForecastWeather.List> weatherList, Context context, String tempUnit) {
    ...
    public void updateCollection(List<com.app.weather.model.ForecastWeather.List> weatherList){
        this.weatherList = weatherList;
