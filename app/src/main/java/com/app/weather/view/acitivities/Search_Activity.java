...
import com.app.weather.adapter.SearchForecastRVAdapter;
...
import com.app.weather.model.ForecastWeather.List;
import com.app.weather.utils.Constant;
import com.app.weather.utils.TimeAndDateConverter;
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(searchString)){
                    findViewById(R.id.relLaySearch).setVisibility(View.GONE);
                    Toast.makeText(Search_Activity.this, "Type a city", Toast.LENGTH_SHORT).show();
                }
                ...
                .enqueue(new Callback<CurrentWeatherResponse>() {
                    ...
                    public void onFailure(Call<CurrentWeatherResponse> call, Throwable t) {
                        Log.e("onFailure", "SearchWeatherByCity: "+t.getLocalizedMessage()+"\n"+
                                t.getMessage());
                        Toast.makeText(Search_Activity.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                .enqueue(new Callback<ForecastWeatherResponse>() {
                    ...
                    public void onResponse(Call<ForecastWeatherResponse> call, Response<ForecastWeatherResponse> response) {
                        if (response.isSuccessful()){
                            ...
                            adapter = new SearchForecastRVAdapter(weatherLists, Search_Activity.this, temp_unit);
...
/*                            if (adapter == null){
                    ...
                    public void onFailure(Call<ForecastWeatherResponse> call, Throwable t) {
                        Toast.makeText(Search_Activity.this, " Failed to load"+ t.getMessage(), Toast.LENGTH_SHORT).show();
